...
if __name__ == "__main__":
    ...
    poly = np.array(((204, 379), (531, 305), (920, 490), (396, 716)))

    # [(204, 379), (531, 305), (920, 490), (396, 716)]
    img = sv.draw_filled_polygon(img, poly, color1, 0.5)
    img = sv.draw_polygon(img, poly, sv.Color.WHITE, 12)
    img = sv.draw_text(img, "A", sv.Point(204, 379), color2, 2, 6)
    img = sv.draw_text(img, "B", sv.Point(531, 305), color2, 2, 6)
    img = sv.draw_text(img, "C", sv.Point(920, 490), color2, 2, 6)
    img = sv.draw_text(img, "D", sv.Point(396, 716), color2, 2, 6)
