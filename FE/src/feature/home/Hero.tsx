...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-32 pb-20 px-6 lg:px-12 overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8 animate-slide-up">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-teal-500/20 border border-white/10 backdrop-blur-md shadow-inner hover:scale-105 transition-transform">
        ...
        >
          <div className="relative w-80 h-80 bg-gradient-to-tr from-blue-600/20 via-teal-400/20 to-transparent rounded-3xl backdrop-blur-lg border border-white/10 shadow-2xl overflow-hidden group hover:scale-105 transition-transform duration-700">
            {/* Grid overlay */}
            <svg
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-teal-400 flex items-center justify-center animate-pulse">
            ...
            {[0, 1, 2, 3].map((i) => (
              ...
              >
                <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-teal-400 to-blue-500 animate-pulse" />
              </div>
            ))}
          </div>
        </div>
