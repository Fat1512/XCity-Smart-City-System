...
interface AuthLayoutProps {
  ...
  title: string;
  subtitle?: string;
  logoUrl?: string; // logo hoặc emblem
  bannerUrl?: string; // banner city
}
...
const AuthLayout: React.FC<AuthLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 relative overflow-hidden">
      {/* Soft Green Glow */}
      ...
      <div className="relative z-10 w-full max-w-6xl bg-white/10 backdrop-blur-2xl border border-emerald-400/20 rounded-3xl shadow-[0_25px_90px_rgba(16,185,129,0.25)] overflow-hidden flex">
        ...
        <div className="w-1/2 p-10 flex flex-col justify-center items-center bg-gradient-to-b from-emerald-700/40 to-emerald-600/30 border-r border-emerald-400/20">
          {/* Logo */}
          {logoUrl && (
            <img
              src={logoUrl}
