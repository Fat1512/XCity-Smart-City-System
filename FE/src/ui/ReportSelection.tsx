  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-16 text-center relative z-10">
        <h1 className="text-6xl font-extrabold mb-6 bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent animate-gradient">
          Báo Cáo Thông Minh
        </h1>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
        {reports.map((report, index) => (
          ...
          >
            <div
              className={`absolute -inset-1 bg-linear-to-r ${report.gradient} rounded-3xl blur opacity-0 group-hover:opacity-75 transition duration-500 ${report.bgGlow}`}
            ></div>
            ...
            <div className="relative h-full bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-3">
              ...
              <div className="relative p-8 flex flex-col items-center text-center h-full">
                <div
                  className={`mb-6 p-6 rounded-2xl bg-linear-to-br ${report.gradient} shadow-2xl transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                >
              ...
              <div
                className={`absolute top-0 left-0 right-0 h-1 bg-linear-to-r ${report.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
              ></div>
            </div>
          </div>
        ))}
